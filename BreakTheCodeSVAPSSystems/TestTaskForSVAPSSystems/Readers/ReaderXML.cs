...
namespace TestTaskForSVAPSSystems.Readers
{
    internal class ReaderXML : IReader<MainModel>
    {
        private readonly IFormatProvider provider = CultureInfo.InvariantCulture.NumberFormat;
